...
# omarchy-session agent inside Omarchy picks it up (see omarchy/session). run-omarchy.sh hands QEMU this script and
# the share folder in MYLINUX_SESSION_CMD. Usage: omarchy-session-mac.sh <share dir> save|restore|interval <min|off>
set -eu
