...
Window {
    ...
    readonly property var keybindings: [
        { group: "Apps", keys: [["⌘ Enter", "Terminal"], ["⌘ ⇧ Enter", "Browser (Firefox)"], ["⌘ ⇧ F", "Files"], ["⌘ Space / ⌘ Esc / ⌘ D / ⌃ ⌘ Space", "Menu: type to find anything"], ["⌘ ⇧ Esc", "System menu"], ["⌘ K", "This list"]] },
    ...
    Shortcut { sequences: ["Meta+Space", "Meta+Esc", "Meta+Shift+Space", "Meta+D", "Ctrl+Meta+Space", "Ctrl+Alt+Esc", "Meta+Alt+Space", "Ctrl+Alt+Space"]; context: Qt.ApplicationShortcut; onActivated: spotlight.open ? spotlight.hide() : spotlight.show("menu") }   // ⌘⇧Space and ⌘D: fallbacks when macOS owns Option+Space / Option+Esc (Siri, Spoken Content)
