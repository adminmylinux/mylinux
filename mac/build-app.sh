...
# Install Script… (the Debian terminal) loads debian_install.sh from GitHub; this copy stands in when it can't
cp debian_install.sh "$NEW/Contents/Resources/debian_install.sh"
